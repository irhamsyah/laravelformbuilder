...
<head>
	...
	<link rel="stylesheet" href="{{URL::asset('asset/css/jquery.ui.theme.css')}}" />
	...
	<script src="{{URL::asset('asset/js/beautifyhtml.js')}}"></script>
	<style>
		...
		<div class="row">
			<div class="col-md-3" style="padding: 0px 30px 30px 30px; background-color: #fff;">
				...
				<form role="form">
					...
					<div class="form-group draggable">
						...
						<input type="email" class="form-control" id="input-email-1"
							placeholder="Email">
						<p class="help-block">Example block-level help text here.</p>
					</div>
					...
					<div class="radio draggable">
					<label>
						<input type="radio"> <span >tes me out</span>
					</label>
					</div>
			...
			<div class="col-md-9" style="padding: 30px;">
				<div style="background-color: #fff; border-radius: 5px; padding: 20px; 
					...
					<div class="text-muted empty-form text-center" style="font-size: 24px;">
							{!! $idlisttemplate->isi !!}
					</div>
